...
(use-package codeium
    ...
    :hook
    (prog-mode . ismd/codeium-capf-setup)
    (text-mode . ismd/codeium-capf-setup)
    (eglot-managed-mode . ismd/eglot-codeium-capf-setup)

    :init
    (defun ismd/codeium-capf-setup ()
      (unless (bound-and-true-p eglot--managed-mode)
        (add-to-list 'completion-at-point-functions #'codeium-completion-at-point t)))

    (defun ismd/eglot-codeium-capf-setup ()
...
(use-package copilot-chat
  ...
  :custom
  (copilot-chat-commit-model "claude-sonnet-4.6")
