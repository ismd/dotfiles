...
;; Suppress fontification errors from jit-lock-stealth-fontify
;; (broken go-ts-mode queries trigger treesit-query-error and
;;  args-out-of-range repeatedly during background fontification)
(define-advice jit-lock-stealth-fontify
    (:around (orig-fn &rest args) ismd/ignore-fontify-errors)
  (condition-case nil
      (apply orig-fn args)
    ((treesit-query-error args-out-of-range) nil)))
