...
(ismd/leader-keys-C-c
  ...
  "f D" '(ismd/delete-this-file-permanently :wk "Delete this file permanently")
  ...
  "f y" '(ismd/copy-file-path :wk "Copy file path"))
#+end_src
...
(ismd/leader-keys-C-c
  ...
  "h o" '(helpful-at-point :wk "Describe symbol at point")
...
(ismd/leader-keys-C-c
  ...
  "l h" '(eldoc-doc-buffer :wk "Show eldoc info")
...
(ismd/leader-keys-C-c
  ...
  "n i" '(org-roam-node-insert :wk "Insert node link")
  "n j" '(org-roam-dailies-capture-today :wk "Daily note")
  "n l" '(org-roam-buffer-toggle :wk "Toggle backlinks"))
#+end_src
...
(ismd/leader-keys-C-c
  ...
  "r w" '(window-configuration-to-register :wk "Save window configuration to register"))
#+end_src
...
(ismd/leader-keys-C-c
  ...
  "t e" '(flymake-mode :wk "Toggle error checking")
  "t l" '(display-line-numbers-mode :wk "Toggle line numbers")
  "t o" '(olivetti-mode :wk "Toggle olivetti")
  "t s" '(ismd/toggle-streaming-mode :wk "Toggle streaming mode")
...
(general-define-key
 ...
 "TAB" nil
 "<tab>" nil
 "C-v" '(corfu-scroll-up :wk "Scroll down")
 "M-v" '(corfu-scroll-down :wk "Scroll up"))
#+end_src
...
(general-define-key
 ...
 "RET" '(ismd/dirvish-find-file :wk "Find file (smart)")
 ...
 "^"   '(dirvish-subtree-up :wk "Subtree up")
 "?"   '(dirvish-dispatch :wk "Dispatch menu")
 "C"   '(ismd/dired-do-copy :wk "Copy (C-u = current dir)")
 "D"   '(ismd/dired-do-delete :wk "Delete (C-u = permanent)")
 ...
 "o"   '(ismd/dirvish-open-in-other-window :wk "Open in other window")
 "R"   '(ismd/dired-do-rename :wk "Rename (C-u = current dir)")
 "r"   '(dirvish-history-jump :wk "Jump to history")
 "s"   '(dirvish-quicksort :wk "Quicksort menu")
 "x"   '(ismd/dired-do-flagged-delete :wk "Delete flagged (C-u = permanent)")
