...
Display navigation breadcrumbs in the header line showing your position in code structure (imenu) and project hierarchy (project.el).
...
(use-package olivetti
  :ensure t
  :preface
  (defun ismd/git-gutter-update-after-olivetti ()
    "Update git-gutter after olivetti-mode is toggled."
    (when (bound-and-true-p git-gutter-mode)
      (git-gutter:update-all-windows)))
  :hook (olivetti-mode . ismd/git-gutter-update-after-olivetti)
  :custom
