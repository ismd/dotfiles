...
hl.bind(mainMod .. " + F10",        hl.dsp.exec_cmd("~/.bin/volume.sh toggle"),     { locked = true, repeating = true })
...
hl.bind(mainMod .. " + SHIFT + P", hl.dsp.exec_cmd("dms screenshot"))
